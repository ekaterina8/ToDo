...
PDO - работает с базами данных

вставлять адд из формы в базы данных задачи

join

-> для вызова метода
=> для инициализации пары ключ/значение

CRUD добавление обновление удаление и чтение
M model 
V viewer
c - controller
